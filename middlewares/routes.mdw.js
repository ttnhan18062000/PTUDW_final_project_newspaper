...
module.exports = function (app) {
  app.get('/', async function (req, res) {
      ...
      if(parent.ParentCategoryID === null){
        ...
        list.forEach(child => {
          if(child.ParentCategoryID === parent.ID){
            const newChild = {ID: child.ID, Name: child.Name, listChildCategories: null};
            temp.push(newChild);
          }
        });
        const newParent = { ID: parent.ID, Name: parent.Name, listChildCategories: temp};
    ...
    console.log(listParentCategories);
    res.render('home',{
